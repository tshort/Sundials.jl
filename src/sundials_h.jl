...
const PREC_NONE = @compat (UInt32)(0)
const PREC_LEFT = @compat (UInt32)(1)
const PREC_RIGHT = @compat (UInt32)(2)
const PREC_BOTH = @compat (UInt32)(3)
...
const MODIFIED_GS = @compat (UInt32)(1)
const CLASSICAL_GS = @compat (UInt32)(2)
